...
#' 
#' \itemize{
#'   \item zip:     The US Postal Service ZIP code
#'   \item lat:     Decimal latitude north
...
#' \itemize{
#'   \item zip:     The US Postal Service ZIP code
#'   \item cases:   The number of cases observed
#'   \item long:    The date on which the cases were observed in that ZIP code
#'   }
#'   
...
#' 
#' \itemize{
#'   \item county:     The US Postal Service ZIP code
#'   \item cases:   The number of cases observed
#'   \item long:    The date on which the cases were observed in that ZIP code
#'   }
#'   
...
#' 
#' \itemize{
#'   \item locationid:     Postal code ID
...
#' \itemize{
#'   \item locationid:     Postal code ID
##'   \item numcases:        The number of cases observed
#'   }
#'   
...
#' \itemize{
#'   \item locationid:     Postal code ID
##'   \item numcontrols:        The number of controls observed
#'   }
#'   
#' @format A data frame with 191 observations and 2 variables
#' @source Distributed with SaTScan software: \url{http://www.satscan.org}
